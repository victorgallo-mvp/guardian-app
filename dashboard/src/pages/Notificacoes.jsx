...
import { CheckCircle2, Eye, XCircle, Clock, Filter } from "lucide-react";
      ...
      {carregando ? (
        ...
        <div className="space-y-3">
          {dados.dados.map((n) => {
            ...
            const gatilho = n.analiseId?.detectado?.gatilho ?? "";
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      ...
                      {severidade && (
                        <span className={`badge ${SEVERIDADE_CONFIG[severidade] ?? ""}`}>
                          {severidade}
                        </span>
                      )}
                    ...
                    <p className="text-sm text-gray-700 line-clamp-2">{n.conteudoMensagem}</p>
                    {n.responsavelId?.nome && (
                      <p className="text-xs text-gray-400 mt-1.5">
                        Para: {n.responsavelId.nome}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    {n.status === "enviada" && (
                      <>
                        <button
                          onClick={() => atualizarStatus(n._id, "ciente")}
                        ...
                        <button
                          onClick={() => atualizarStatus(n._id, "resolvida")}
                        ...
                        <button
                          onClick={() => atualizarStatus(n._id, "ignorada")}
                          title="Ignorar"
